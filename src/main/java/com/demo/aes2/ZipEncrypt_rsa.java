...
public class ZipEncrypt_rsa {
    ...
    public static void encryptZip(String srcFile, String destfile,
        ...
        dos.writeObject(ZipEncrypt_rsa.privateKey);
        ...
        // 对文件加密
        encrypt(temp.getAbsolutePath(), destfile, publicKey);
        temp.delete();
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        ZipEncrypt_rsa.encryptZip("D:/Rsa/download/tmp", "D:/Rsa/download/tmp.txt", "D:/Rsa/download/b.key");

        ZipEncrypt_rsa.decryptUnzip("D:/Rsa/download/tmp.txt", "D:/Rsa/download/tmp2", ZipEncrypt_rsa.getKey("D:/Rsa/download/b.key"));
